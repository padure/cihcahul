...
<div class="container admin-body col-md-8 col-md-offset-2">
    <div class="col-md-12 admin">
        ...
        <a href="{{ url('admin/evenimente')}}"><div class="col-md-3 color-2"><img src="{{URL::asset('img/sistems/logo/if_39_Calendar_106206.png')}}" alt="Imaginea lipseste">
                <h4 class="text-center">Evenimente</h4></div></a>
    </div>
    <div class="col-md-12 admin">
        ...
        <a href="{{url('admin/galerie') }}"><div class="col-md-3 color-2"><img src="{{URL::asset('img/sistems/logo/if_084_Photo_183212.png')}}" alt="Imaginea lipseste">
                <h4 class="text-center">Galerie</h4></div></a>
