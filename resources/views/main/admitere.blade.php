...
<head>
  ...
  <!-- Basic -->
  <title>Admitere: CIHCAHUL - Colegiul Iulia Hasdeu Din Cahul</title>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <ul class="contact-details">
                ...
                <li><a href="#"><i class="fa fa-envelope-o"></i> cihsecretariat@cihcahul.md</a>
                </li>
    ...
    <footer>
      <div class="container">
        <div class="row footer-widgets">
          ...
          <div class="col-md-3">
            <div class="footer-widget twitter-widget">
              <h4><a href="{{route('home')}}">Acasă</a><span class="head-line"></span></h4>
             <ul>
            <li>   
			   <a href="{{URL("/about")}}"> Despre</a>
              </li>
          ...
          <div class="col-md-3">
            <div class="footer-widget contact-widget">
              ...
              <ul>
                <li><span>Phone Number:</span> 029941530</li>
                <li><span>Email:</span> cihsecretariat@cihcahul.md</li>
                <li><span>Website:</span> www.cihcahul.md</li>
              </ul>
            </div>
          </div>
          <!-- .col-md-3 -->
        ...
        <div class="copyright-section">
          <div class="row">
            <div class="col-md-6">
              <p> Copyright&copy; 2017 Colegiul Iulia Hasdeu dinCahul. Toate drepturile rezervate<a href="http://cihcahul.md"> CIH</a> </p>
            </div>
